...
frappe.ui.form.on("Closing Drivers Commission", {
  get_data: function(frm) {
    frappe.call({
    "method": "commissions.commissions.doctype.closing_drivers_commission.closing_drivers_commission.getCB",
args: {
...
frappe.ui.form.on("Closing Drivers Commission", {
  get_data: function(frm) {
    ...
    frappe.call({
    "method": "commissions.commissions.doctype.closing_drivers_commission.closing_drivers_commission.insert_data",
args: {
beneficiary: frm.doc.beneficiary,
...
frappe.ui.form.on("Closing Drivers Commission", {
  get_data: function(frm) {
    frappe.call({
    "method": "commissions.commissions.doctype.closing_drivers_commission.closing_drivers_commission.getCODorder",
args: {
beneficiary: frm.doc.beneficiary,
from_date: frm.doc.from_date,
to_date: frm.doc.to_date
...
frappe.ui.form.on("Closing Drivers Commission", {
  get_data: function(frm) {
    frappe.call({
    "method": "commissions.commissions.doctype.closing_drivers_commission.closing_drivers_commission.getDELDC",
args: {
beneficiary: frm.doc.beneficiary
},
callback:function(r){
